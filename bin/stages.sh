...
stage_estimate () {
  ...
  local atlas_template_memory=$(python -c "print int(max(1, (${a} *  ${template_voxels} + ${b} * ${atlas_voxels}) * ${scaling_factor}))")
  local template_subject_memory=$(python -c "print int(max(1, (${a} *  ${subject_voxels} + ${b} * ${template_voxels}) * ${scaling_factor}))")
  ...
  local atlas_template_walltime_seconds=$(python -c "print int((${d} *  ${template_voxels} + ${e} * ${atlas_voxels} + ${f}) * ${scaling_factor})")
  local template_subject_walltime_seconds=$(python -c "print int((${d} *  ${subject_voxels} + ${e} * ${template_voxels} + ${f}) * ${scaling_factor})")
